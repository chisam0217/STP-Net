...
class Model(object):
    ...
    #     frames_tensor = torch.FloatTensor(frames).to(self.configs.device)
    #     mask_tensor = torch.FloatTensor(mask).to(self.configs.device)
    #     # print ('frames_tensor', frames_tensor.size())
    #     flops = count_ops(self.network, (frames_tensor, mask_tensor))
    #     # print ('next_frames', next_frames.size())
    #     return next_frames.detach().cpu().numpy(), flops